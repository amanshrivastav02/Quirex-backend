...
//     const { name,email,contact, password,address,userId } = req.body;
//     const {profile}=req.files;
//     profile.mv("uploads/" + profile?.name, (err) => {
//       if (err) {
//         res.json({
...
//       }
//     })
//     const result = await userModel.findByIdAndUpdate({_id:userId },{name,email,contact, password,address,profile:profile?.name},{new:true});
//     if(result){
//       res.json({
//       code: 200,
